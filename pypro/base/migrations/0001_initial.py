# Generated by Django 3.2.12 on 2022-03-14 20:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='Designates wheter the user can log into '
                                                                          'this admin site.', verbose_name='staff '
                                                                                                           'status')),
                ('is_active', models.BooleanField(default=True, help_text='Designates wheter this user should be '
